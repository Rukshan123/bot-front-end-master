    ...
    const features = [
        {
            ...
            description:
                "Import data from multiple sources to train your agent.",
        },
        {
            icon: "🎨",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="space-y-8">
                            ...
                            <p className="text-gray-600 text-lg">
                                Saass chatbot will help you build a custom AI
                                agent, embed it on your website and let it
                                handle customer support, lead generation, user
                                engagement, and lot more.
                            </p>
                ...
                <div className="container mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold mb-4">
                            Everything You Need to Build, Customize, and Scale
                            Your Agent in One Place.
                        </h2>
                    </div>
